...
app.post('/saveAssesment', (req, res) => {
    ...
    fs_extra.writeJsonSync(
        './dist/assesment_list.json',
        assemsentList
    );
...
app.post('/savetask', (req, res) => {
    ...
    fs_extra.writeJsonSync(
        './dist/task_list_1.json',
        inspector1
    );
    fs_extra.writeJsonSync(
        './dist/task_list_2.json',
        inspector2
    );
    fs_extra.writeJsonSync(
        './dist/task_list_3.json',
        inspector3
    );
    fs_extra.writeJsonSync(
        './dist/task_list_4.json',
        inspector4
    );
