...
public class PDBSCANClusterer<V> {
     ...
     */
    public PDBSCANClusterer(FeatureCollection inputValues, int minNumElements, double maxDistance, DistanceMetric<V> metric) throws DBSCANClusteringException {
     ...
     * @throws DBSCANClusteringException
     */
    public void setInputValues(final FeatureCollection collection) throws DBSCANClusteringException {
        if (collection == null) {
